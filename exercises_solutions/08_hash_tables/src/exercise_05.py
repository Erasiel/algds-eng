# Create the special deleted flag
_deleted = object()
...
class HashSetOpenAddressing:
    ...
    def insert(self, key: int) -> None:
        ...
        for i in range(self.num_slots):
            ...
            # If the slot is empty or contains the deleted flag, insert the key
    ...
    def delete(self, key: int) -> None:
        ...
        for i in range(self.num_slots):
            ...
            # If the slot contains the key, set the slot's content to the
            # deleted flag
            if self.table[slot] == key:
